...
<body>
    ...
    <div class="content">
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            // ✅ Column name "date" used instead of "attendance_date"
            $sql = "INSERT INTO attendance (student_id, date, status) VALUES ('$student_id', '$attendance_date', " . ($attendance == 1 ? "'Present'" : "'Absent'") . ")";
